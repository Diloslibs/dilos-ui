  ...
  <div class="my-0 mx-auto min-h-full max-w-screen-md py-16">
    <div class="flex flex-col gap-5">
        <div class="flex flex-col gap-3">
            ...
            <p class="text-xl font-semibold">Basic Dropdown</p>
        ...
        <div class="flex flex-col gap-3">
            <p class="text-xl font-semibold">Dropdown Checkbox</p>
            <div class="flex gap-3">
                <div class="">
                    <button
        ...
        <div class="flex flex-col gap-3">
            <p class="text-xl font-semibold">Dropdown With Icons</p>
            <div class="flex gap-3">
                <div class="">
                    <button
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdown-icons" class="d-dropdown hidden">
                        <div class="d-dropdown-item-container">
                            <div class="d-dropdown-item">
                                <svg
                                    width="16"
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex gap-3">
                <div class="">
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdown-search" class="d-dropdown hidden">
                        <div class="d-dropdown-item-container">
                            <div class="d-dropdown-search">
                                <input
                                    type="text"
                                    class="d-input-text sm w-60"
                    ...
                    <div
                        ...
                        <div class="d-dropdown-item-container">
                            ...
                            <div class="d-dropdown-footer">
                                <div
                                    class="flex gap-2 justify-end w-52">
                                    <button
                                        class="d-btn primary-outline xs">
                                        Button
                                    </button>
        ...
        <div class="flex flex-col gap-3">
            <p class="text-xl font-semibold">Dropdown Placement</p>
